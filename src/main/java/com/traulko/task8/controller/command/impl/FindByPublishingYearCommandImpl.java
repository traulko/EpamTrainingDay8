...
public class FindByPublishingYearCommandImpl implements Command {
    @Override
    public Map<String, Object> execute(Map<String, Object> parameters) {
        Map<String, Object> response = new HashMap<>();
        BookStorageService bookStorageService = new BookStorageServiceImpl();
        try {
            List<CustomBook> books = bookStorageService.findByPublishingYear((int) parameters.get(ParameterType.PUBLISHING_YEAR));
