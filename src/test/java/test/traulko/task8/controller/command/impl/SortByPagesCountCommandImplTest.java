...
import com.traulko.task8.controller.command.impl.SortByPagesCountCommandImpl;
...
public class SortByPagesCountCommandImplTest {
    Command sortByCountPagesCommand;

    @BeforeClass
    public void setUp() {
        sortByCountPagesCommand = new SortByPagesCountCommandImpl();
    }

    @AfterClass
    public void tearDown() {
        sortByCountPagesCommand = null;
    }
    ...
    public void executePositiveTest() {
        ...
        Map<String, Object> actual = sortByCountPagesCommand.execute(parameters);
