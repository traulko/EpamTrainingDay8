...
public class SortByIdCommandImplTest {
    Command sortByIdCommand;

    @BeforeClass
    public void setUp() {
        sortByIdCommand = new SortByIdCommandImpl();
    }

    @AfterClass
    public void tearDown() {
        sortByIdCommand = null;
    }
    ...
    public void executePositiveTest() {
        ...
        Map<String, Object> actual = sortByIdCommand.execute(parameters);
