...
import com.traulko.task8.controller.command.impl.SortByAuthorCommandImpl;
...
public class SortByAuthorCommandImplTest {
    Command sortByAuthorCommand;

    @BeforeClass
    public void setUp() {
        sortByAuthorCommand = new SortByAuthorCommandImpl();
    }

    @AfterClass
    public void tearDown() {
        sortByAuthorCommand = null;
    }
    ...
    public void executePositiveTest() {
        ...
        Map<String, Object> actual = sortByAuthorCommand.execute(parameters);
